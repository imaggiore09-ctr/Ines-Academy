    ...
    lessons: [
      ...
      },
      {
        ...
        contenido: [
          ...
          'Los prints o ediciones limitadas amplian la base sin canibalizar la obra original, siempre que dejes clara la diferencia de valor.',
        ],
        clave: [
          'Escalera: accesible · grueso · ancla.',
          'Prints amplian público sin restar al original.',
        ],
