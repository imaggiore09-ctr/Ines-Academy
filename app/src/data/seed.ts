...
export const ATELIER_SEED: AppState = {
  ...
  SOCIAL: {
    ...
    reels: [
      'Timelapse de una obra de principio a fin',
      'La mezcla del rojo perfecto',
      'Mi rincón del estudio a primera hora',
      'Desembalar el material nuevo',
    ],
    stories: [
      'Encuesta: ¿cuál de estas dos obras?',
      'Detrás de cámara del secado',
      'Pregunta abierta: ¿qué te transmite el blanco?',
    ],
    carruseles: [
      '3 obras + su historia',
      'Antes / después de un encargo',
      'Mi paleta explicada',
    ],
    frases: [
    ...
    guiones: [
      'Reel presentación: «Hola, soy Inés…» (15s)',
      'Reel proceso: capas de óleo (30s)',
    ],
    checklist: [
      '¿La foto está bien iluminada?',
      '¿El texto cuenta una historia?',
      '¿Hay llamada a la interacción?',
      '¿Hashtags revisados?',
