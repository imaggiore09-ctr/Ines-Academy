/* ATELIER — contenido educativo (estático, no persistido) */
(function () {
  ...
  window.ATELIER_EDU = { TASK_INFO, SHOP_INFO, OBLIGACIONES, LEGAL_PREGUNTAS, FISCAL_MODULES,
    TASK_SUB, TASK_ICON, SHOP_ICON, LEGAL_FECHAS, LEGAL_DOCS, LEGAL_SUB, LEGAL_ICON };
})();
